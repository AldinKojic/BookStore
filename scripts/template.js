        ...
        <div class="shadow-wrapper">
          ...
          <div class="meta-content">
            <div class="book-price-like">
              ...
              <p class="book-likes">
                <span id="likeCount-${i}">${books[i].likes}</span>
                <img onclick="addLike(${i})" class="like-symbol" src="./img/heart.png" alt="heart-symbol">
              </p>
            </div>
          ...
          <div class="comments-wrapper">
            <h3 class="comment-headline">Kommentare:</h3>
            ...
            <div class="write-comment">
              ...
              />
              <button onclick="addComment(${i})" class="send-comment">
                <img class="send-symbol" src="./img/send-symbol.png" alt="send-symbol">
              </button>
            </div>
          </div>
